...
import { ExtensionsContentProps } from "../ExtensionsContent";

interface ExtensionProps {
  params: ExtensionsContentProps;
}

export default function Extension({ params }: ExtensionProps) {
  return (
    <li className="justify-content-center" key={params["extension-id"]}>
      ...
      <Image src={dots} className={styles["dots-img"]} alt="Card decor" />
